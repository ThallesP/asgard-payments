...
export class Provider extends pulumi.ProviderResource {
    ...
    /**
     * Name of the service token to use. Alternatively, use `PLANETSCALE_SERVICE_TOKEN_ID`. Mutually exclusive with
     * `service_token_id` and `service_token`.
     */
    ...
    /**
     * ID of the service token to use. Alternatively, use `PLANETSCALE_SERVICE_TOKEN_ID`. Mutually exclusive with
     * `access_token`.
     */
     ...
     * `access_token`. (Deprecated, use `service_token_id` instead)
     *
    ...
    terraformConfig(): pulumi.Output<{[key: string]: any}> {
        const result: pulumi.Output<Provider.TerraformConfigResult> = pulumi.runtime.call("pulumi:providers:planetscale/terraformConfig", {
            "__self__": this,
