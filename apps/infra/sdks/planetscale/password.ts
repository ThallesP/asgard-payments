...
export class Password extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly accessHostUrl: pulumi.Output<string>;
    /**
     * The actor that created this branch.
     */
    declare public /*out*/ readonly actor: pulumi.Output<outputs.PasswordActor>;
    /**
     * The branch this password belongs to.
     */
    declare public readonly branch: pulumi.Output<string>;
    /**
     * List of IP addresses or CIDR ranges that can use this password. Individual IPs must still contain a prefix, eg:
     * 127.0.0.1/32
     */
     ...
     */
    declare public /*out*/ readonly databaseBranch: pulumi.Output<outputs.PasswordDatabaseBranch>;
    /**
     ...
     */
    declare public /*out*/ readonly region: pulumi.Output<outputs.PasswordRegion>;
    /**
     * Whether or not the password can be renewed.
     */
    declare public /*out*/ readonly renewable: pulumi.Output<boolean>;
    /**
     * When true, all queries from this password will be read-only and directed to a replica. Requires role to be set to
     * reader.
     */
